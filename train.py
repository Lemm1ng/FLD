"""Script for model training. Model is ResNext_50_32x4d (pretrained on ImageNet)."""
...
from utils import ScaleMinSideToSize, TransformByKeys, CropRandom
...
def main(args):
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=20, verbose=True)
    loss_fn = fnn.l1_loss
